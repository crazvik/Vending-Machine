...
public class VendingMachineClass implements VendingMachine {
	protected final int[] insertableValues;
	private int change;
	protected final Product[] products;
	protected boolean keepBuying;
	protected final ArrayList<Product> boughtProducts;
	
	public VendingMachineClass() {
		insertableValues = new int[] {1, 5, 10, 20, 50, 100, 500, 1000};
		boughtProducts = new ArrayList<>();
		Soda soda = new Soda("Coke", "20", "no allergens", "100 calories/litre");
		Chips chips = new Chips("Chips", "60", "can contain traces of lactose", "300 calories/100g");
		Candy chocolate = new Candy("Chocolate", "140", "can contain traces of nuts", "150 calories/200g");
